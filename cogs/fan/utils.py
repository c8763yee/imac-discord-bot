...
TURN_ON_FAN_PAYLOAD = {
    FanPosition.BACK_DOOR: {"fan_0": "OUT", "fan_1": "OUT"},
    FanPosition.FRONT_DOOR: {"fan_0": "IN", "fan_1": "IN"},
    FanPosition.MEETING_ROOM: {"fan_0": "IN"},
}

TURN_OFF_FAN_PAYLOAD = {
    FanPosition.BACK_DOOR: {"fan_0": "OFF", "fan_1": "OFF"},
    FanPosition.FRONT_DOOR: {"fan_0": "OFF", "fan_1": "OFF"},
    ...
    async def turn_on(self, fan_position: FanPosition) -> str:
        async with Client(MQTT_BROKER, MQTT_PORT) as client:
            await client.publish(
                f"{self.TOPIC_PREFIX}/{fan_position}/control",
